...
const services = [
  {
    ...
    desc: "We restore your vehicle's paint to a mirror-like finish through precision machine polishing, followed by a premium ceramic shield for long-lasting gloss and protection.",
    image: "/services/paint-ceramic.avif",
    path: "/services/paint-correction-ceramic-coat",
  },
  {
    title: "SPECIALIST VEHICLE DETAILING",
    desc: "A meticulous deep-cleaning process for both interior and exterior, ensuring every inch of your vehicle is restored to showroom condition with expert care.",
    image: "/services/specialist-detailing.avif",
    path: "/services/specialist-detailing",
  },
  {
    title: "MAINTENANCE WASH",
    desc: "Our safe, multi-stage washing process designed to maintain your vehicle's appearance and protect existing coatings without causing any swirl marks.",
    image: "/services/maintenance-wash.avif",
    path: "/services/maintenance-wash",
  },
];
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {services.map((service, index) => (
             ...
             hover:scale-105 active:scale-105 bg-black/80 hover:shadow-primary hover:border-primary/80 dark:bg-black/20 transition-all duration-300"
                data-aos="fade-up"
              ...
              >
                ...
                <div className="max-w-sm mx-auto ">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-50  bg-white "
                    onError={(e) => {
