...
const testimonials = [
{
    "text": "Mark is phenomenal! He’s completely transformed my car from a kids’ trashed tip to looking like new again. The interior is spotless and shiny, and the paint correction outside is incredible, all those scratches are gone. I’d seen how much care and attention Mark puts into every car he works on, treating them like his own, so I finally booked mine in and he didn’t disappoint! You can tell he takes real pride in what he does. Worth every penny and more. Thanks, Mark!",
    "name": "Nicole Lancashire"
  }
];
